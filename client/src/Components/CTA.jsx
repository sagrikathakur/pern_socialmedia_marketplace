...
const CTA = () => {
  return (
    <div className='my-20 flex items-center justify-center px-4'>
      <div className="max-w-5xl w-full p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
        <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF] px-4">
          ...
          <h2 className="text-2xl md:text-4xl font-medium mt-4 leading-[1.2]">
          ...
          <p className="text-slate-500 mt-4 max-w-lg max-md:text-sm">Achieve your goals faster with personalized strategies, hands-on support, and results that speak for themselves.</p>
          <button type="button" className="bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm px-6 py-3 rounded-xl font-medium mt-6 hover:scale-105 active:scale-95 transition-all duration-300">
            Get Started Today
          </button>
        </div>
      </div>
